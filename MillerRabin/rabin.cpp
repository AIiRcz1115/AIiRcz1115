// rabin.cpp : Defines the entry point for the console application.
//
...
// do obliczenia liczb neiparzystych
class MillerRabin
{
...
public:	
	...
	bool executeAlgorithm(long n, int k) {
		long s = 0;	
		long a, d, prime;
		bool result = false;
...
{
	MillerRabin rabin;
	if (rabin.executeAlgorithm(99999999999999, 20) ==1) { cout << "liczba prawdopodobnie pierwsza"; }
	else {
